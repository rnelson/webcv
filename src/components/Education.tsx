            ...
            <div className="education-list">
                {
                    schools.schools.map(school =>
                        <div key={school.degree} className="school pb-2 pt-2 font-light text-xl/[1.2] lg:text-2xl/[1.2]">
                            ...
                            <div className="grid grid-cols-1 mt-[-0.05rem] lg:mt-[0.15rem] lg:grid-cols-12 lg:gap-4">
                                <div className="col-span-1 lg:col-span-9">{school.degree}</div>
                            </div>
                            {school.other?.length && (
                                <div className="grid grid-cols-1 mt-[-0.05rem] lg:mt-[-0.05rem] lg:grid-cols-12 lg:gap-4">
